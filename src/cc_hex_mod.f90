...
SUBROUTINE CC_HEX_MAIN(cc_hex_params,face_ids,vertices,apertures)
	...
	!other
	REAL(8) :: pi, targetdiff, ystep, x0, y0, devmax, as, z, zd, offset
	INTEGER :: m, m2, j1, j2, szfc2, szfc1, nphr, sz1t, szfc3, pfhfb, s, e, v1, v2, szp1, szp
	...
	INTEGER :: j1, itlim, dp0, dq0, p, q, pqval, n
	REAL(8) :: K, pi, p1, p1sq, p2, cc, ccp1, ccp2, diff, diffold, zpqr, zpqi, sdzr, sdzi, Kx, Ky, rn, pKx, psq
	REAL :: rnd1, rnd2
