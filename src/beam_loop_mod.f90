...
subroutine beam_loop(   beam_outbeam_tree, &
    ...
    if(job_params%debug >= 2) then
        ...
        ! print'(A,f8.2,A)','particle illuminated faces: ',real(sizeof(F1Mapping))/1048576D0,' MB'
        ! print'(A,f8.2,A)','beam propagation vecs: ',real(sizeof(propagationVectors))/1048576D0,' MB'
        ! print'(A,f8.2,A)','particle normals: ',real(sizeof(Norm))/1048576D0,' MB'
        ! print'(A,f8.2,A)','particle midpoints: ',real(sizeof(midPoints))/1048576D0,' MB'
        ...
        ! print'(A,f8.2,A)','amplitude matrices: ',real(sizeof(refl_ampl_out11Int))/1048576D0,' MB'
        ! print'(A,f8.2,A)','external diff beamtree: ',real(sizeof(ext_diff_outbeam_tree))/1048576D0,' MB'
